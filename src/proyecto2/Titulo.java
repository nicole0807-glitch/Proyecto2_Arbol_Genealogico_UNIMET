...
public class Titulo extends javax.swing.JFrame {
     ...
     */
    public Titulo(Arbol arbol, HashTable table) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 170, 170, -1));
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 310, 260, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NodoArbol nodo = arbol.buscarNodoPorNombreCompleto(arbol.raiz, this.jComboBox1.getSelectedItem().toString());
        
        System.out.println(this.jComboBox1.getSelectedItem().toString());
        JOptionPane.showMessageDialog(rootPane, nodo.obtenerDatosNodo());
    
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String titulo = this.nombre.getText();
        NodoArbol[] nodos =this.arbol.buscarPorCargo(titulo);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Titulo(arbol, table).setVisible(true);
            }
        });
    }
